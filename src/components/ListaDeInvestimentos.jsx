    ...
    <div className="bg-zinc-900 p-6 rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {investimentos.map((inv) => {
          ...
          const RiskIcon = LucideIcons.ChartNoAxesColumnIncreasing;
          const FgcIcon = inv.fgc ? LucideIcons.Check : LucideIcons.X;
          const fgcColor = inv.fgc ? 'text-green-500' : 'text-red-500';
          return (
            <div
              key={inv.id}
              className="p-6 border border-zinc-800 rounded-lg bg-zinc-800 shadow-md flex flex-col h-full min-h-[270px]" // min-h garante altura mínima
              style={{ minHeight: 270 }}
            >
