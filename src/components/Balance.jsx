    ...
    <div className="bg-neutral-900 p-6 rounded-lg shadow-md mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-4xl font-bold text-white">{format(balance)}</p>
          <p className="text-lg text-blue-400 mt-1">+ {format(totalInvested)} Investidos</p>
        </div>

        {/* Coluna 2 - Valor Investido e Retorno Médio */}
        <div className="flex flex-col">
          <p className="text-lg text-gray-400">Valor Investido</p>
          <p className="text-4 sxl font-bold text-white">{format(totalInvested)}</p>
